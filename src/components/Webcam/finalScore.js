            ...
            <header>
                <div
                    ...
                    <button
                        ...
                        {props.score < 1000 ? <p>You suck</p> : props.score > 1000 && props.score < 5000 ? <p>You're pretty alright</p> : props.score > 5000 && props.score < 10000  ? <p>Amazing</p> : props.score > 10000 ? <p>Not as good as Bill</p> : <p></p>}
                </div>
            </header>
        </div>
    );
